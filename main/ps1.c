...
static void esp_zb_task(void *pvParameters)
{
    ...
    //End points
    {
        ...
        esp_zb_occupancy_sensing_cluster_cfg_t occupancy_cfg = {
            .occupancy = 0,
            .sensor_type = ESP_ZB_ZCL_OCCUPANCY_SENSING_OCCUPANCY_SENSOR_TYPE_ULTRASONIC,
            .sensor_type_bitmap = 0x02, // Bit 1 set for Ultrasonic
        };
        //By default there will be occupany attribute created with attrId = ESP_ZB_ZCL_ATTR_OCCUPANCY_SENSING_OCCUPANCY_ID
        esp_zb_attribute_list_t *occ_attr_l = esp_zb_occupancy_sensing_cluster_create(&occupancy_cfg);
        esp_zb_cluster_list_add_occupancy_sensing_cluster(cl, occ_attr_l, ESP_ZB_ZCL_CLUSTER_SERVER_ROLE);
